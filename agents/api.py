"""
FastAPI REST API Server for Zk Proof Of Vaccination Pki.
"""
...
app = FastAPI(
    title="Zk Proof Of Vaccination Pki API",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "zk-proof-of-vaccination-pki", "domain": "Post-Quantum Cryptography & Hardware Security", "standard": "NIST FIPS 203/204/205 / ISO/IEC 17825 Standards", "version": "3.0.0-ENTERPRISE"}
